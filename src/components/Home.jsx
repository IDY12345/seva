        ...
        mobile && (
          <div className="Main-sidebar">
            <div className={sidebar1 ? "Inner-Main active" : "Inner-Main1"}>
              ...
              {/* <motion.div className="Pipes-sidebar1" animate={{ scale: 1 }} initial={{ scale: 0 }} transition={{ duration: 2.5 }}>
                <img src="assets\pipy-removebg-preview.png" alt="" className='Pipes-side' />
              </motion.div> */}
            </div>
          </div>
        )
